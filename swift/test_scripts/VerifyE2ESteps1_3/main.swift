...
let refPath = "/Users/a10n/Projects/nightingale/verification_outputs/e2e_steps1_3"

print(String(repeating: "=", count: 80))
print("END-TO-END VERIFICATION: STEPS 1-3")
print(String(repeating: "=", count: 80))
...
do {
    ...
    let allPass = step1Pass && step2Pass && step3Pass
